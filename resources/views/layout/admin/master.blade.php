...
<head>
    ...
    <!-- Page Title  -->
    <title>organi admin | {{$title ?? "home"}}</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <ul class="nk-quick-nav">
                                    ...
                                    <li class="dropdown user-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="{{ route('admin.signout') }}"><em class="icon ni ni-signout"></em><span>Sign out</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
    ...
    <!-- .modal -->
    <!-- JavaScript -->
    <script src="/assets/admin/js/bundle.js?ver=2.9.1"></script>
    <script src="/assets/admin/js/scripts.js?ver=2.9.1"></script>
    <script src="/assets/admin/js/charts/chart-ecommerce.js?ver=2.9.1"></script>
</body>
