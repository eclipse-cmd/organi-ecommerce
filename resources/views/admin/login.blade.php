                            ...
                            <form action="{{ route('admin.login.auth')  }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="email" name="email" class="form-control form-control-lg" id="email" placeholder="Enter your email" name="email">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                    ...
                                    <div class="form-label-group" style="float: right; margin-top: 2px" >
                                        <a class="link link-primary link-sm" style="margin-top: 13px" href="">Forgot Password?</a>
                                    </div>
                                </div>
                                <div class="form-group">
